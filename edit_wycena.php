...
// wyszukanie wyceny po nr wyceny
$szukaj_nr_wyc = $db->prepare("SELECT DISTINCT nr_wyceny FROM wycena WHERE nr_wyceny LIKE 'W101'");
$szukaj_nr_wyc->execute();

$szukaj_nr_wyc_admin = $db->prepare("SELECT DISTINCT admin FROM wycena WHERE nr_wyceny LIKE 'W101'");
$szukaj_nr_wyc_admin->execute();

$szukaj_nr_wyc_data = $db->prepare("SELECT DISTINCT data FROM wycena WHERE nr_wyceny LIKE 'W101'");
$szukaj_nr_wyc_data->execute();

$szukaj_klienta = $db->prepare("SELECT DISTINCT klientID FROM wycena WHERE nr_wyceny LIKE 'W101'");
$szukaj_klienta->execute();

$szukaj_sprzetu = $db->prepare("SELECT DISTINCT sprzet, marka, model, zestaw, opis_usterki FROM wycena WHERE nr_wyceny LIKE 'W101'");
$szukaj_sprzetu->execute();

$szukaj_platnosci = $db->prepare("SELECT * FROM wycena WHERE nr_wyceny LIKE 'W101'");
$szukaj_platnosci->execute();
    ...
    <form class="form_serwis" method="post">
        ...
        <div class="naglowek_top">
            <div class="wycena_label">
                <input class="nr_label" type="text" name="nr_wyceny" id="nr_wyceny" value="<?php
                                                                                            foreach ($szukaj_nr_wyc as $value) {
                                                                                                echo $value['nr_wyceny'];
                                                                                            }
                                                                                            ?>" required>
                <span class="nr_span">Nr wyceny</span>
            </div>

            <div class="wycena_label_a">
                <div class='wycena_label'>
                    <!-- id serwisanta -->
                    <span class="admin_span2_id"><i class='icon-adult'></i></span>
                    <input class="admin_label_id" type="text" id="admin1" name="admin1" value="<?php
                                                                                                foreach ($szukaj_nr_wyc_admin as $value) {
                                                                                                    echo $value['admin'];
                                                                                                }
                                                                                                ?>" required>
                    <span class="admin_span_id">ID serwisanta</span>
                </div>
                <div class='wycena_label'>
                    <!-- wyuszkanie danych serwisanta po id  -->
                    <span class="admin_span2"><i class='icon-adult'></i></span>
                    <?php echo '<input class="admin_label" type="text" id="admin2" name="admin2" value="' .
            ...
            <div class="wycena_label">
                ...
                <input class="data_label" type="date" name="data" id="data" value="<?php foreach ($szukaj_nr_wyc_data as $value) {
                                                                                        echo $value['data'];
                                                                                    }
                                                                                    ?>" required>
        ...
        <div class="panel_serwis">
            ...
            <div class="panel">
                ...
                <div class="dane_klienta" id="dane_klienta">
                    ...
                    <div class="dane_klienta_d" id="dane_klienta_d">
                        <div class='dane_klienta_d2' id='dane_klienta_d2'></div>
                        <div class="wycena_label">
                ...
                <div class="dane_sprzetowe" id="dane_sprzetowe">
                    ...
                    foreach ($szukaj_sprzetu as $value) {

                        echo "<div class='wycena_label'>
                        <input class='sprzet_label' type='text' name='sprzet' id='sprzet' value='{$value['sprzet']}' required>
                    ...
                    <div class='wycena_label'>
                        <input class='marka_label' type='text' name='marka' id='marka' value='{$value['marka']}' required>
                    ...
                    <div class='wycena_label'>
                        <input class='model_label' type='text' name='model' id='model' value='{$value['model']}' required>
                    ...
                    <div class='wycena_label'>
                        <input class='zestaw_label' type='text' name='zestaw' id='zestaw' value='{$value['zestaw']}' required>
                    ...
                    <div class='wycena_label'>
                        <input class='opis_label' type='text' name='opis_usterki' id='opis' value='{$value['opis_usterki']}' style='text-transform: none;' required>
            ...
            <div class="wycena" id="wycena">
                ...
                <?php
                $i = 0;
                foreach ($szukaj_platnosci as $value) {
                    $i++;

                    echo "<div class='wyc_poj' id='wyc_poj$i'>
                        <div class='wycena_pojemnik' id='wycena_pojemnik$i'>
                        <div class='wycena_label'>
                            <input class='nazwa_label' type='text' name='nazwa$i' id='nazwa$i' value='{$value['nazwa']}' required>
                            <span class='nazwa_span'>Część/Usługa</span>
                        </div>
                        <div class='wycena_label'>
                            <input class='ilosc_label' type='text' name='ilosc$i' id='ilosc$i' value='{$value['ilosc']}' required>
                            <span class='ilosc_span'>Ilość</span>
                            <span class='ilosc_span2'>szt</span>
                        </div>
                        <div class='wycena_label'>
                            <input class='cena_label' type='text' name='cena_podz$i' id='cena_podz$i' value='{$value['cena_podz']}' required>
                            <span class='cena_span'>Cena części</span>
                            <span class='cena_span2'>zł</span>
                        </div>
                        <div class='wycena_label'>
                            <input class='cena_label' type='text' name='cena_uslugi$i' id='cena_uslugi$i' value='{$value['cena_uslugi']}' required>
                            <span class='cena_span'>Cena usługi</span>
                            <span class='cena_span2'>zł</span>
                        </div>
                        <div class='wycena_label'>
                            <input class='marza_label' type='text' name='marza$i' id='marza$i' value='{$value['marza']}' required>
                            <span class='marza_span'>Marza</span>
                            <span class='marza_span2'>%</span>

                            <input class='marza_label' type='text' name='marza_zl$i' id='marza_zl$i' required>
                            <span class='marza_zl_span2'>zł</span>
                        </div>
                        <div class='wycena_label'>
                            <input class='rabat_label' type='text' name='rabat$i' id='rabat$i' value='{$value['rabat']}' required>
                            <span class='rabat_span'>Rabat</span>
                            <span class='rabat_span2'>%</span>

                            <input class='rabat_label' type='text' name='rabat_zl$i' id='rabat_zl$i' required>
                            <span class='rabat_zl_span2'>zł</span>
                        </div>
                        <div class='wycena_label'>
                            <input class='naleznosc_label' type='text' name='naleznosc$i' id='naleznosc$i' value='{$value['naleznosc']}' required>
                            <span class='naleznosc_span'>Należność</span>
                            <span class='naleznosc_span2'>zł</span>
                        </div>
                        <div class='wycena_label'>
                            <input class='zysk_label' type='text' name='zysk$i' id='zysk$i' value='{$value['zysk']}' required>
                            <span class='zysk_span'>Zysk</span>
                            <span class='zysk_span2'>zł</span>
                        </div>
                        <div class='wycena_label'>
                            <select class='status_label' name='status$i' id='status$i' required>
                    ...
                    <div class='numeracja'>
                        <div class='nr' id='numer$i' name='numer$i'>$i
                        </div>
                        <input type='text' class='n_label' id='n$i' name='n' value='$i'>
                    </div>
                    <div class='czysc_pozycje'>
                        <input type='button' class='czysc_label' id='czysc_poz$i' value='Czyść' onclick='czysc_pozycje_platnosciowe$i()'>
                    </div>
                </div>
                </div>";
                }
    ...
    <script>
        ...
        setInterval(function() {
            ...
            if (nazwa.length >= 3 && ilosc.length >= 1 && cena_podz.length >= 1 && cena_uslugi.length >= 1 &&
                ...
                document.getElementById("wycena_pojemnik1").style.cssText = style_border +
                ...
                document.getElementById("wycena_pojemnik1").style.cssText = style_border_wh +
        ...
        dodaj.addEventListener('click', e => {
            if (i <= 4) {
                ...
                if (document.getElementById('wyc_poj' + i) != null) {
                    i = 2;
                    i++;
                }
        ...
        $(document).ready(function() {
            // wyszukanie admina
            $('#admin1').show(function() {
                $.ajax({
                    type: 'POST',
                    url: 'szukaj_admin.php',
                    data: {
                        name: $('#admin1').val(),
                    },
        ...
        $(document).ready(function() {
            ...
            $('#klientID').show(function() {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#dane_klienta_d2').html(data);
                    },
                });
            });

            $('#klientID').keyup(function() {
                $.ajax({
                    type: 'POST',
                    url: 'szukaj_klienta.php',
                    data: {
